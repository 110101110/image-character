...
FontConfig::FontSet FontConfig::rebuild_font_atlas(
	...
	float ascii_font_size)
{
	...
	// Independently configurable ASCII-output font.
	...
	{
		std::cerr
			<< "Failed to load ASCII font: "
			<< ascii_font_definition.path
			<< '\n';

		// Use the fixed interface font as a safe fallback.
